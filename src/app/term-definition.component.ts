...
@Component({
  selector: 'app-term-definition',
  templateUrl: './term-definition.component.html',
  styleUrls: ['./term-definition.component.css']
})
export class TermDefinitionComponent implements OnInit {
  // Initialization 
  term : FormAddTerm;
